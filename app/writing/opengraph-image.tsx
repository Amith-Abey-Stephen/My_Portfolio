...
export const alt = `Writing & Technical Notes — ${site.author}`;
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            Honest reflections on product engineering, systems architecture, security, and lessons from building software.
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex", gap: 12 }}>
            {["System Architecture", "PostgreSQL", "Docker Security", "AI Tools"].map(
              (badge) => (
                <div
                  key={badge}
                  style={{
