...
export const alt = `Resume & Track Record — ${site.author}`;
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            Full-stack developer at FinalApps, former CEO of Inovus Labs, and frontend tech lead at μLearn Foundation.
          </div>
        </div>
        ...
        >
          <div style={{ display: "flex", gap: 12 }}>
            {["Next.js", "TypeScript", "Shopify Apps", "Docker & DevOps", "IoT Systems"].map(
              (badge) => (
                <div
                  key={badge}
                  style={{
